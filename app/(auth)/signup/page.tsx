...
export default function SignUp() {
  const [state, handleSubmit] = useForm("xrbzwknp"); // Replace with your Formspree form ID
        ...
        <div className="py-12 md:py-20">
          ...
          <form onSubmit={handleSubmit} className="mx-auto max-w-[400px]">
            ...
            <div className="mt-6 space-y-5">
              ...
              <a href="https://calendly.com/chiragagrawal774/30min"
                    target="_blank"
                    rel="noopener noreferrer">
              <button type="button" className="btn relative w-full bg-gradient-to-b from-gray-800 to-gray-800/60 bg-[length:100%_100%] bg-[bottom] text-gray-300 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,theme(colors.gray.800),theme(colors.gray.700),theme(colors.gray.800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] hover:bg-[length:100%_150%]">
